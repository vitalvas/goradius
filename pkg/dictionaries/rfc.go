...
var StandardRFCAttributes = []*dictionary.AttributeDefinition{
	...
	{ID: 20, Name: "Callback-Id", DataType: dictionary.DataTypeString},        // RFC2865
	{ID: 22, Name: "Framed-Route", DataType: dictionary.DataTypeString},       // RFC2865
	{ID: 23, Name: "Framed-IPX-Network", DataType: dictionary.DataTypeIPAddr}, // RFC2865
	{ID: 24, Name: "State", DataType: dictionary.DataTypeOctets},              // RFC2865
	{ID: 25, Name: "Class", DataType: dictionary.DataTypeOctets},              // RFC2865
	{ID: 26, Name: "Vendor-Specific", DataType: dictionary.DataTypeOctets},    // RFC2865
	...
	{ID: 34, Name: "Login-LAT-Service", DataType: dictionary.DataTypeString},         // RFC2865
	{ID: 35, Name: "Login-LAT-Node", DataType: dictionary.DataTypeString},            // RFC2865
	{ID: 36, Name: "Login-LAT-Group", DataType: dictionary.DataTypeOctets},           // RFC2865
	{ID: 37, Name: "Framed-AppleTalk-Link", DataType: dictionary.DataTypeInteger},    // RFC2865
	...
	{ID: 50, Name: "Acct-Multi-Session-Id", DataType: dictionary.DataTypeString},  // RFC2866
	{ID: 51, Name: "Acct-Link-Count", DataType: dictionary.DataTypeInteger},       // RFC2866
	{ID: 52, Name: "Acct-Input-Gigawords", DataType: dictionary.DataTypeInteger},  // RFC2869
	{ID: 53, Name: "Acct-Output-Gigawords", DataType: dictionary.DataTypeInteger}, // RFC2869
	...
	{ID: 58, Name: "Egress-VLAN-Name", DataType: dictionary.DataTypeString},    // RFC4675
	...
	{ID: 68, Name: "Acct-Tunnel-Connection", DataType: dictionary.DataTypeString},                                                         // RFC2867
	...
	{ID: 73, Name: "ARAP-Security", DataType: dictionary.DataTypeInteger},     // RFC2869
	...
	{ID: 77, Name: "Connect-Info", DataType: dictionary.DataTypeString},                          // RFC2869
	{ID: 78, Name: "Configuration-Token", DataType: dictionary.DataTypeString},                   // RFC2869
	...
	{ID: 84, Name: "ARAP-Challenge-Response", DataType: dictionary.DataTypeOctets},               // RFC2869
	{ID: 85, Name: "Acct-Interim-Interval", DataType: dictionary.DataTypeInteger},                // RFC2869
	{ID: 86, Name: "Acct-Tunnel-Packets-Lost", DataType: dictionary.DataTypeInteger},             // RFC2867
	...
	{ID: 89, Name: "Chargeable-User-Identity", DataType: dictionary.DataTypeOctets},              // RFC4372
	{ID: 90, Name: "Tunnel-Client-Auth-Id", DataType: dictionary.DataTypeString, HasTag: true},   // RFC2868
	{ID: 91, Name: "Tunnel-Server-Auth-Id", DataType: dictionary.DataTypeString, HasTag: true},   // RFC2868
	...
	{ID: 102, Name: "EAP-Key-Name", DataType: dictionary.DataTypeOctets},                   // RFC4072
	{ID: 103, Name: "Digest-Response", DataType: dictionary.DataTypeString},                // RFC5090
	{ID: 104, Name: "Digest-Realm", DataType: dictionary.DataTypeString},                   // RFC5090
	{ID: 105, Name: "Digest-Nonce", DataType: dictionary.DataTypeString},                   // RFC5090
	{ID: 106, Name: "Digest-Response-Auth", DataType: dictionary.DataTypeString},           // RFC5090
	{ID: 107, Name: "Digest-Nextnonce", DataType: dictionary.DataTypeString},               // RFC5090
	{ID: 108, Name: "Digest-Method", DataType: dictionary.DataTypeString},                  // RFC5090
	{ID: 109, Name: "Digest-URI", DataType: dictionary.DataTypeString},                     // RFC5090
	{ID: 110, Name: "Digest-Qop", DataType: dictionary.DataTypeString},                     // RFC5090
	{ID: 111, Name: "Digest-Algorithm", DataType: dictionary.DataTypeString},               // RFC5090
	{ID: 112, Name: "Digest-Entity-Body-Hash", DataType: dictionary.DataTypeString},        // RFC5090
	{ID: 113, Name: "Digest-CNonce", DataType: dictionary.DataTypeString},                  // RFC5090
	{ID: 114, Name: "Digest-Nonce-Count", DataType: dictionary.DataTypeString},             // RFC5090
	{ID: 115, Name: "Digest-Username", DataType: dictionary.DataTypeString},                // RFC5090
	{ID: 116, Name: "Digest-Opaque", DataType: dictionary.DataTypeString},                  // RFC5090
	{ID: 117, Name: "Digest-Auth-Param", DataType: dictionary.DataTypeString},              // RFC5090
	{ID: 118, Name: "Digest-AKA-Auts", DataType: dictionary.DataTypeString},                // RFC5090
	{ID: 119, Name: "Digest-Domain", DataType: dictionary.DataTypeString},                  // RFC5090
	{ID: 120, Name: "Digest-Stale", DataType: dictionary.DataTypeString},                   // RFC5090
	{ID: 121, Name: "Digest-HA1", DataType: dictionary.DataTypeString},                     // RFC5090
	{ID: 122, Name: "SIP-AOR", DataType: dictionary.DataTypeString},                        // RFC5090
	{ID: 123, Name: "Delegated-IPv6-Prefix", DataType: dictionary.DataTypeIPv6Prefix},      // RFC4818
	{ID: 124, Name: "MIP6-Feature-Vector", DataType: dictionary.DataTypeOctets},            // RFC5447
	{ID: 125, Name: "MIP6-Home-Link-Prefix", DataType: dictionary.DataTypeOctets},          // RFC5447
	{ID: 126, Name: "Operator-Name", DataType: dictionary.DataTypeString},                  // RFC5580
	{ID: 127, Name: "Location-Information", DataType: dictionary.DataTypeOctets},           // RFC5580
	{ID: 128, Name: "Location-Data", DataType: dictionary.DataTypeOctets},                  // RFC5580
	...
	{ID: 135, Name: "Management-Policy-Id", DataType: dictionary.DataTypeString},                 // RFC5607
	{ID: 136, Name: "Management-Privilege-Level", DataType: dictionary.DataTypeInteger},          // RFC5607
	{ID: 137, Name: "PKM-SS-Cert", DataType: dictionary.DataTypeOctets},                          // RFC5904
	{ID: 138, Name: "PKM-CA-Cert", DataType: dictionary.DataTypeOctets},                          // RFC5904
	{ID: 139, Name: "PKM-Config-Settings", DataType: dictionary.DataTypeOctets},                  // RFC5904
	{ID: 140, Name: "PKM-Cryptosuite-List", DataType: dictionary.DataTypeOctets},                 // RFC5904
	{ID: 141, Name: "PKM-SAID", DataType: dictionary.DataTypeInteger},                            // RFC5904
	{ID: 142, Name: "PKM-SA-Descriptor", DataType: dictionary.DataTypeOctets},                    // RFC5904
	{ID: 143, Name: "PKM-Auth-Key", DataType: dictionary.DataTypeOctets},                         // RFC5904
	{ID: 144, Name: "DS-Lite-Tunnel-Name", DataType: dictionary.DataTypeOctets},                  // RFC6519
	{ID: 145, Name: "Mobile-Node-Identifier", DataType: dictionary.DataTypeOctets},               // RFC6572
	{ID: 146, Name: "Service-Selection", DataType: dictionary.DataTypeString},                    // RFC6572
	{ID: 147, Name: "PMIP6-Home-LMA-IPv6-Address", DataType: dictionary.DataTypeIPv6Addr},        // RFC6572
	{ID: 148, Name: "PMIP6-Visited-LMA-IPv6-Address", DataType: dictionary.DataTypeIPv6Addr},     // RFC6572
	{ID: 149, Name: "PMIP6-Home-LMA-IPv4-Address", DataType: dictionary.DataTypeIPAddr},          // RFC6572
	...
	{ID: 158, Name: "PMIP6-Visited-DHCP4-Server-Address", DataType: dictionary.DataTypeIPAddr},   // RFC6572
	{ID: 159, Name: "PMIP6-Home-DHCP6-Server-Address", DataType: dictionary.DataTypeIPv6Addr},    // RFC6572
	{ID: 160, Name: "PMIP6-Visited-DHCP6-Server-Address", DataType: dictionary.DataTypeIPv6Addr}, // RFC6572
	...
	{ID: 164, Name: "GSS-Acceptor-Service-Name", DataType: dictionary.DataTypeString},      // RFC7055
	{ID: 165, Name: "GSS-Acceptor-Host-Name", DataType: dictionary.DataTypeString},         // RFC7055
	{ID: 166, Name: "GSS-Acceptor-Service-Specifics", DataType: dictionary.DataTypeString}, // RFC7055
	{ID: 167, Name: "GSS-Acceptor-Realm-Name", DataType: dictionary.DataTypeString},        // RFC7055
	{ID: 168, Name: "Framed-IPv6-Address", DataType: dictionary.DataTypeIPv6Addr},          // RFC6911
	{ID: 169, Name: "DNS-Server-IPv6-Address", DataType: dictionary.DataTypeIPv6Addr},      // RFC6911
	{ID: 170, Name: "Route-IPv6-Information", DataType: dictionary.DataTypeIPv6Prefix},     // RFC6911
	{ID: 171, Name: "Delegated-IPv6-Prefix-Pool", DataType: dictionary.DataTypeString},     // RFC6911
	{ID: 172, Name: "Stateful-IPv6-Address-Pool", DataType: dictionary.DataTypeString},     // RFC6911
	{ID: 173, Name: "IPv6-6rd-Configuration", DataType: dictionary.DataTypeTLV},            // RFC6930
	{ID: 174, Name: "Allowed-Called-Station-Id", DataType: dictionary.DataTypeString},      // RFC7268
	{ID: 175, Name: "EAP-Peer-Id", DataType: dictionary.DataTypeOctets},                    // RFC7268
	{ID: 176, Name: "EAP-Server-Id", DataType: dictionary.DataTypeOctets},                  // RFC7268
	{ID: 177, Name: "Mobility-Domain-Id", DataType: dictionary.DataTypeInteger},            // RFC7268
	{ID: 178, Name: "Preauth-Timeout", DataType: dictionary.DataTypeInteger},               // RFC7268
	{ID: 179, Name: "Network-Id-Name", DataType: dictionary.DataTypeOctets},                // RFC7268
	{ID: 180, Name: "EAPoL-Announcement", DataType: dictionary.DataTypeOctets},             // RFC7268
	{ID: 181, Name: "WLAN-HESSID", DataType: dictionary.DataTypeString},                    // RFC7268
	{ID: 182, Name: "WLAN-Venue-Info", DataType: dictionary.DataTypeInteger},               // RFC7268
	{ID: 183, Name: "WLAN-Venue-Language", DataType: dictionary.DataTypeOctets},            // RFC7268
	{ID: 184, Name: "WLAN-Venue-Name", DataType: dictionary.DataTypeString},                // RFC7268
	{ID: 185, Name: "WLAN-Reason-Code", DataType: dictionary.DataTypeInteger},              // RFC7268
	{ID: 186, Name: "WLAN-Pairwise-Cipher", DataType: dictionary.DataTypeInteger},          // RFC7268
	{ID: 187, Name: "WLAN-Group-Cipher", DataType: dictionary.DataTypeInteger},             // RFC7268
	{ID: 188, Name: "WLAN-AKM-Suite", DataType: dictionary.DataTypeInteger},                // RFC7268
	{ID: 189, Name: "WLAN-Group-Mgmt-Cipher", DataType: dictionary.DataTypeInteger},        // RFC7268
	{ID: 190, Name: "WLAN-RF-Band", DataType: dictionary.DataTypeInteger},                  // RFC7268
	{ID: 241, Name: "Extended-Attribute-1", DataType: dictionary.DataTypeOctets},           // RFC6929
	{ID: 242, Name: "Extended-Attribute-2", DataType: dictionary.DataTypeOctets},           // RFC6929
	{ID: 243, Name: "Extended-Attribute-3", DataType: dictionary.DataTypeOctets},           // RFC6929
	{ID: 244, Name: "Extended-Attribute-4", DataType: dictionary.DataTypeOctets},           // RFC6929
